...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-[#8B3A2A] text-[#FFFEFA] hover:bg-[#743022] active:bg-[#5A2418] shadow-elevation1',
      secondary:
        'bg-transparent border border-secondaryCta-border text-clay dark:border-[#D79A8A] dark:text-white hover:bg-secondaryCta-hoverBackground active:bg-[#F3ECE8]',
