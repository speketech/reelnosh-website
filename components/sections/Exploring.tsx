                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      {/* Status Badge */}
                      <div>
                        <span className="bg-[#F7F3ED] text-[#5A2418] border border-[#E7DED5] dark:bg-[#2A211D] dark:text-[#F7F3ED] dark:border-[#4A352E] text-[11px] font-semibold px-2.5 py-0.5 rounded-full inline-block shadow-xs">
